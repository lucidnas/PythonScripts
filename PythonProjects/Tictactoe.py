...
def insert_mark(position):
    ...
    if position_row < 0 or position_row > 2:
        print "Wrong row, please try again!"
        user_input()
    if position_col < 0 or position_col > 2:
